// This program makes a ServerSocketChannel and waits for client requests.
// Once connected, it sends data
import java.io.*;
    ...
    public void go() {
        try (ServerSocketChannel serverChannel = ServerSocketChannel.open()) {
            ...
            while (serverChannel.isOpen()) {
                ...
                PrintWriter writer = new PrintWriter(Channels.newOutputStream(socketToClient));
