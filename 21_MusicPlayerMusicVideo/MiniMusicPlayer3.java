...
public class MiniMusicPlayer3 {
    private MyDrawPanel panel; // Why is this here tho? Shouldn't it go inside go function?
    ...
    public void setUpGui() {
        ...
        frame.setContentPane(panel); // New thing - previously I wasn't doing this
    ...
    public void go() {
        ...
        try {
            ...
            Track track = seq.createTrack(); // Create a track object of the Sequence object
    ...
    class MyDrawPanel extends JPanel implements ControllerEventListener {
        ...
        public void controlChange(ShortMessage event) {
            msg = true;
            this.repaint(); // can also be written as just repaint() without the "this"
        }
